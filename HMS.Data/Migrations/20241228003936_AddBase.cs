        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHotelGuest = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccommodationPackages", x => x.ID);
                    table.ForeignKey(
                        name: "FK_AccommodationPackages_AccommodationTypes_AccommodationTypeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accommodations_AccommodationPackages_AccommodationPackageID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationDates_Rooms_RoomID",
                        column: x => x.RoomID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationNumber = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    DateFrom = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateTo = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AdultCount = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    ChildrenCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    BreakfastAdults = table.Column<int>(type: "int", nullable: false),
                    LunchAdults = table.Column<int>(type: "int", nullable: false),
                    DinnerAdults = table.Column<int>(type: "int", nullable: false),
                    BreakfastChildren = table.Column<int>(type: "int", nullable: false),
                    LunchChildren = table.Column<int>(type: "int", nullable: false),
                    DinnerChildren = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccommodationPackages_AccommodationTypeID",
                table: "AccommodationPackages",
                column: "AccommodationTypeID");

            migrationBuilder.CreateIndex(
                name: "IX_Accommodations_AccommodationPackageID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationDates_RoomID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableReservations_TableNumber_ReservationDate",
                table: "TableReservations",
                columns: new[] { "TableNumber", "ReservationDate" },
                unique: true);
        }
